const translations = {
  en: {
    ...
    lingHouseTitle: "Ling House: Echoes Within",
    lingHouseDescription: "A psychological horror game about exploring a haunted house and confronting the echoes within.",
  ...
  zh: {
    ...
    lingHouseTitle: "灵宅：回音缭绕",
    lingHouseDescription: "一款探索诡异宅邸、直面其中回音的心理恐怖游戏。",
